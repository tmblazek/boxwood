  ...
  <div class="fullwidth-block">
    <div class="container">
      <div class="col-sm-6">
        ...
        <div>{{$k->start_t}}: <a href="/konzerte/{{$k->id}}">{{$k->title}}</a>: {!! null ===$k->setlist ? '<a href="/internal/setlists/create?konzerte='.$k->id.'">Keine Setlist Vorhanden, neue erstellen</a>': '<a href="/internal/setlists/'.$k->setlist->id.'>'.$k->setlist->title."</a>" !!}</div>
        @endforeach
      </div>
<div class="col-sm-6">
